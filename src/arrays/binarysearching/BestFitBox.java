/*
 * 
 * In one of Amazon fulfillment centers, there are a no. of empty boxes kept in increasing order in
 * a row. Kiva robots are designed to put a product in a box. The product size is given. Design a
 * program to find the best fit box for given product size. First line contains no. of empty boxes
