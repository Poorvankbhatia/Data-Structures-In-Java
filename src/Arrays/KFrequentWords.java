...
2. The minHeap is not full. we will insert the new word into min heap & update the root dllNode in the min heap dllNode & min heap index in Trie leaf dllNode. Now, call buildMinHeap().
